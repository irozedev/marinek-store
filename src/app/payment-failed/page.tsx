 ...
 *
 * Сюди веде НЕ WayForPay: окремого declineUrl у їхньому Purchase API нема
 * (перевірено в документації 04.08.2026). Адресу обирає наша функція
 * payment-return — вона дивиться на підписане тіло повернення й на статус
 * замовлення в базі, і лише коли відмова точно розпізнана, віддає 303 сюди.
 * У сумнівному випадку людина йде на /thank-you, чий текст правдивий і
 * тоді, коли оплати не було.
 */
