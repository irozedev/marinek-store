...
export default function AdminApp() {
  ...
  return (
    ...
    // вона ~70px на телефоні і ~76px на десктопі, тож 112px вистачає
    // з полем на смугу жестів айфона.
    <div className="min-h-screen bg-[#f6f2f8] pb-28">
      ...
      <main className="mx-auto flex max-w-[760px] flex-col gap-5 px-5 py-6">
        ...
        <p className="m-0 rounded-2xl bg-white/70 px-4 py-3 text-[13px] leading-[1.55] text-muted">
          Зміни зберігаються самі, але на сайті з’являються лише після кнопки{' '}
          <strong className="text-ink">«Опублікувати»</strong> внизу.
        </p>
